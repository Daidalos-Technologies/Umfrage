...
<div class="menu">
    <a href="./poll_admin?page=manage_questions" class="menu-item btn btn-primary" ><div class="d-flex justify-content-center align-items-center h-100 w-100">Fragen Verwalten</div></a><br>
