...
<div class="menu">
    ...
    <a href="./poll_admin?page=edit" class="menu-item btn btn-Warning"><div class="d-flex justify-content-center align-items-center h-100 w-100">Fragen Bearbeiten/Löschen</div></a>
